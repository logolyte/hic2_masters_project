...
4. Create a Starsolo index in the directory "RNA Sequencing Data/mm10 gencode reference". This can be done by putting an mm10 gtf and fa file with the primary assembly from [Gencode](https://www.gencodegenes.org/mouse/release_M10.html) in the directory and running "generate_star_index.sh". 
